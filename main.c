...
int main(void)
{
    ...
    const char *file1path = "./files/students_data_1a.csv";
    const char *file2path = "./files/students_data_2a.csv";
    const char *deleteFilePath = "./files/delete_students.csv";
    ...
    while (!endMenu)
    {
        ...
        case 2: // 2. Load TOF file with students_data_1a.csv\n
            ...
            else if (made[1] == 0)
            {
                ...
                validatedInsertions = load_TOF_file_from_csv(file1path, &tof_file);
        ...
        case 4: // 4. Expand TOF to TOVS
            ...
            else if (made[3] == 0)
            {
                ...
                expand_TOF_to_TOVS(file2path, tof_file, &tovs_file);
        ...
        case 11:
            ...
            {
                TOF_file tof_file = open_TOF_file(tof_filename);
                delete_TOF_records_from_csv(deleteFilePath, &tof_file);
                printf("\n");
